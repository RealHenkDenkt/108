...
$(document).ready(function () {
    ...
    $('#extraCipher2 option[value=EnglishOrdinalFullReduction]').attr('selected','selected').on('change', buildTable());
    $('#extraCipher3 option[value=EnglishOrdinalReversed]').attr('selected','selected').on('change', buildTable());
    $('#extraCipher4 option[value=EnglishOrdinalReversedFullReduction]').attr('selected','selected').on('change', buildTable());

    $('#extraCipher1, #extraCipher2, #extraCipher3, #extraCipher4').on('change', function () {
        buildTable();
    });
...
*/
    ...
    function buildTable() {
        let table = new OneOEight();
        table.buildTable();
        table.initNumberModal();
    }
